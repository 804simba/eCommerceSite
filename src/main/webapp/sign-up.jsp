                        ...
                        <div class="col-lg-6 col-md-8 u-s-m-b-30">
                            <div class="l-f-o">
                                <div class="l-f-o__pad-box">
                                    ...
                                    <form action="${pageContext.request.contextPath}/sign-up" method="POST" class="l-f-o__form">
                                        <div class="gl-s-api">
                                        ...
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="text" name="reg-fname" id="reg-fname" placeholder="First Name"></div>
                                        <div class="u-s-m-b-30">

                                            <label class="gl-label" for="reg-lname">LAST NAME *</label>

                                            <input class="input-text input-text--primary-style" type="text" name="reg-lname" id="reg-lname" placeholder="Last Name"></div>
<%--                                        <div class="gl-inline">--%>
<%--                                            <div class="u-s-m-b-30">--%>
...
<%--                                        </div>--%>
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="email" name="reg-email" id="reg-email" placeholder="Enter E-mail"></div>
                                        <div class="u-s-m-b-30">

                                            <label class="gl-label" for="reg-password">PASSWORD *</label>

                                            <input class="input-text input-text--primary-style" type="text" name="reg-password" id="reg-password" placeholder="Enter Password"></div>
                                        <div class="u-s-m-b-15">

                                            <button class="btn btn--e-transparent-brand-b-2" type="submit">CREATE</button></div>

                                        <a class="gl-link" href="${pageContext.request.contextPath}/index.jsp">Return to Store</a>
                                    </form>
                                </div>
                            </div>
                        </div>
...
<script src="assets/https://www.google-analytics.com/analytics.js" async defer></script>
